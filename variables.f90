...
real(mytype), save, allocatable, dimension(:,:,:) :: umean,umean_temp,vmean,wmean,uumean,vvmean,wwmean,uvmean,uwmean,vwmean,tmean
real(mytype), save, allocatable, dimension(:,:,:) :: phimean, phiphimean
real(mytype), save, allocatable, dimension(:,:,:) :: p_mean,p_2_mean,vort_mean,vort_2_mean ! omar
...
!arrays for statistic collection!pay attention to the size!
    ...
    allocate (umean_temp(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))
    ...
    allocate (vort_2_mean(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))
    allocate (vort_mean(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))
    allocate (p_2_mean(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))
    allocate (p_mean(xstS(1):xenS(1),xstS(2):xenS(2),xstS(3):xenS(3)))
    if (iscalar==1) then

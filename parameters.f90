...
read (10,1000) a !!! omar
read (10,1000) a !!! omar
read (10,*) i_plasma    !!plasma switch on after this number of iteration  (OMAR)
read (10,*) L_char      !! Char. length used to determine NONdimensional body force (OMAR)
read (10,*) U_Char	!! Char. Velocity used to determine NONdimensional body force (OMAR)
read (10,*) rho		!! density used to determine NONdimensional body force (OMAR)
READ (10,*) V_freq      !! FEQUANCY OF THE APPLIED VOLTAGE
READ (10,*) FORCE_COFF
read (10,1000) a 
close(10) 
if (nrank==0) then
